	...
	<div class="box">
		...
		<div class="box-header with-border">
			<div class="box-title">
				...
				<a title="Go back to all products" href="{{ url('admin/products') }}" class="btn btn-sm btn-default"><i class="fa fa-reply" aria-hidden="true"></i></a> {{$pro->name}}'s Variant
				...
				<small>In: <span class="bolder">{{ $getcatname }}</b> <i class="fa fa-angle-double-right" aria-hidden="true"></i>
			 <span class="font-weight600">{{ $getsubcatname }}</span> <i class="fa fa-angle-double-right" aria-hidden="true"></i>
