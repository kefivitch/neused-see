...
<link rel="stylesheet" href="{{ url('admin/css/style.css') }}">
  ...
  <body>
  	<div class="container">
  		<br>
  		<a href="{{ route('show.order',$order->order_id) }}" title="Go back" class="p_btn2 pull-left btn btn-md btn-default"><i class="fa fa-reply" aria-hidden="true"></i>
  	</a>
						...
						<tr>
							...
							<td>
								...
								<small><b>Sold By:</b> {{$orivar->products->store->name}}</small>
									...
									<br>
								<small class="tax"><b>Tax:</b> <i class="{{ $invoice->order->paid_in }}"></i>{{ round($invoice->tax_amount/$invoice->qty,2) }}</small>
								<br>
