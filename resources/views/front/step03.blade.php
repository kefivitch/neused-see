	...
	<div class="container-fluid">
		<div class="row checkout-box" data-sticky-container> 
			<div class="col-md-8 col-sm-12">
                                ...
                                @if(Session::get('address') != $address->id)
                                  <div class="margin-top8 col-md-6 address-modal">
                                    <div class="custom-control custom-radio">
                                      <input value="{{ $address->id }}" type="radio" class="custom-control-input" name="seladd2" id="seladd2">
              ...
              <div class="form-group">
	             ...
	             <input required="" type="text" class="form-control unicase-form-control text-input" id="billing_name" name="billing_name" value="" placeholder="{{ __('Please Enter Name') }}">
                
        	    </div>

          	  <div class="form-group">
  	            <label class="font-weight-bold" for="exampleInputEmail2">{{ __('staticwords.eaddress') }} <span class="required">*</span></label>
  	            <input required="" type="email" class="form-control unicase-form-control text-input" id="billing_email" name="billing_email" value="" placeholder="{{ __('Please Enter Email') }}">
            	</div>

              <div class="form-group">
                  <label class="font-weight-bold" for="exampleInputEmail1">{{ __('staticwords.ContactNumber') }}<span class="required">*</span></label>
                  <input required="" type="text" class="form-control unicase-form-control text-input" id="billing_mobile" name="billing_mobile" value="" placeholder="{{ __('Please Enter Mobile Number') }}">
                     
              </div>
               @if ($pincodesystem == 1)
                <div class="form-group">

                    <label class="font-weight-bold" for="exampleInputEmail1">{{ __('staticwords.Pincode') }}<span class="required">*</span></label>

                    <input required type="text" class="form-control unicase-form-control text-input" id="billing_pincode" name="billing_pincode" value="" placeholder="{{ __('Please Enter first 3 digit of pincode') }}...">
            ...
            <div class="form-group">
             ...
             <label class="font-weight-bold" for="exampleInputEmail1">{{ __('staticwords.Country') }} <span class="required">*</span></label>
              ...
              <select required="" name="billing_country" class="form-control" id="billing_country">
           ...
           <div class="form-group">
              ...
              <label class="font-weight-bold" for="exampleInputEmail1">{{ __('staticwords.State') }} <span class="required">*</span></label>
                <select required="" name="billing_state" class="form-control" id="billing_state" >
        ...
        <div class="form-group">
          <label class="font-weight-bold" for="exampleInputEmail1">{{ __('staticwords.City') }} <span class="required">*</span></label>
            <select required="" name="billing_city" id="billing_city" class="form-control">
                    ...
                    <div class="cart-grand-total">
                      <div class="row">
                        ...
                        <div class="col-md-8 col-xs-8">
                          ...
                          @else
                              <span class="text-right" id="gtotal"><i class="{{session()->get('currency')['value']}}"></i>{{sprintf("%.2f",($grandtotal-session('coupanapplied')['discount'])*$conversion_rate,2)}}</span>
                          @endif
                        </div>
                      </div>
                    </div>
      ...
      <div class="modal-body">
        <form action="{{ route('address.store') }}" role="form" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="text" required="" id="fname" placeholder="{{ __('Enter name') }}" name="name" class="form-control">
          </div>

          <div class="form-group">
            <label>{{ __('staticwords.PhoneNo') }}: <span class="required">*</span></label>
            <input pattern="[0-9]+" required="" type="text" id="fphone" name="phone" placeholder="{{ __('Enter phone no') }}" class="form-control">
          </div>

          <div class="form-group">
            <label>{{ __('staticwords.Email') }}: <span class="required">*</span></label>
            <input required="" type="email" id="email" name="email" placeholder="{{ __('Enter email') }}" class="form-control">
          </div>
